...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
            <img src="kunyuk.jpg" class="ImgMain" width="200px" height="200px">
            <p align="center" class="paragraf"><cite>Warkop Giemin</cite>
            </p>
            <br>
            <h1 align="center" class="h3 mb-3 fw-hard">Please Login</h1>
            <div class="form-floating">
                <input name="username" type="email" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                <label for="floatingInput">Email address</label>
                <div align="center" class="invalid-feedback">
                    Your email is not valid babe.
                </div>
            </div>
            <div class="form-floating">
            ...
            <p align="center" class="mt-5 mb-3 text-body-secondary">&copy; 2024</p>
        </form>
    </main>
